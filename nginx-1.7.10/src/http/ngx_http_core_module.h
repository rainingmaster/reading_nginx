...
struct ngx_http_phase_handler_s {
    ngx_http_phase_handler_pt  checker; //在ngx_http_core_run_phases对各个阶段的phase_handler调用
    ngx_http_handler_pt        handler; //一般在checker函数内调用
    ngx_uint_t                 next; //next阶段
};
